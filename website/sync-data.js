...
console.log('🔄 Syncing data from root to website...');
...
try {
  ...
  console.log('  📁 Copying controversies...');
  ...
  console.log(`  ✅ Copied ${controversyFiles} controversy files`);
  ...
  console.log('  📇 Generating controversy index...');
  const indexedCount = generateControversyIndex();
  console.log(`  ✅ Indexed ${indexedCount} controversies`);
