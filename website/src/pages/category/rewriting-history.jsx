...
export default function RewritingHistory() {
  ...
  return (
    <Layout title="Rewriting History Controversies" description="Trump's attempts to rewrite documented facts and history">
      <CategoryPage
        categoryId="rewriting-history"
